package com.example.alertas.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleValidationExceptions(
        ...
        ErrorDetails error = new ErrorDetails(LocalDateTime.now(),
                "Error de validación: " + errores, request.getDescription(false));
    ...
    public ResponseEntity<ErrorDetails> handleAccesoDenegado(AccesoDenegadoException ex,
        ...
        ErrorDetails error = new ErrorDetails(LocalDateTime.now(), ex.getMessage(), // Aquí dirá "No
                                                                                    // tienes
                                                                                    // permisos de
                                                                                    // Administrador"
                request.getDescription(false));
